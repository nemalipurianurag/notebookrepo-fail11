...
## google_notebooks_runtime.access_config.access_type
...
resource "google_notebooks_runtime" "managed" {
  ...
  access_config {
    ...
    runtime_owner = "anemalipuri@google.com"
  }
  virtual_machine {
